...
PgBouncer держит пул соединений ближе к клиенту. HAProxy выбирает актуальный маршрут к кластеру по HTTP-проверкам Patroni:

- `/primary` - маршрут записи на текущий основной узел;
